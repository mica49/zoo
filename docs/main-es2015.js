...
let BeastsCardComponent = class BeastsCardComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let WildsCardsComponent = class WildsCardsComponent {
    constructor() { }
    ngOnInit() {
    }
};
...
let PaginationComponent = class PaginationComponent {
    ...
    getNewCurentIndex(current, delta, array) {
...
let PanelBeastsComponent = class PanelBeastsComponent {
...
PanelBeastsComponent.ctorParameters = () => [
...
let PanelBirdsComponent = class PanelBirdsComponent {
    constructor(birdsSvc, paging) {
        this.birdsSvc = birdsSvc;
        this.paging = paging;
    }
    ngOnInit() {
...
PanelBirdsComponent.ctorParameters = () => [
    { type: src_app_serv_birds_serv_service__WEBPACK_IMPORTED_MODULE_2__["BirdsService"] },
...
let PanelWildsComponent = class PanelWildsComponent {
...
PanelWildsComponent.ctorParameters = () => [
